...
export async function GET() {
  ...
  const instructions = [
    ...
    ["Valid Statuses: NOT_STARTED, IN_PROGRESS, ADVANCING, FULFILLED, PARTIAL, BROKEN, REVERSED"],
    [""],
  ...
  const promData = [
    ...
    [
      ...
      "Status (NOT_STARTED, IN_PROGRESS, ADVANCING, FULFILLED, PARTIAL, BROKEN, REVERSED)",
  ...
  promSheet["!dataValidation"] = [
    ...
    },
    {
      sqref: "E3:E1000",
      type: "list",
      formula1: '"NOT_STARTED,IN_PROGRESS,ADVANCING,FULFILLED,PARTIAL,BROKEN,REVERSED"',
    },
  ];
  ...
  const histData = [
    ...
    [
      ...
      "New status (NOT_STARTED, IN_PROGRESS, ADVANCING, FULFILLED, PARTIAL, BROKEN, REVERSED)",
