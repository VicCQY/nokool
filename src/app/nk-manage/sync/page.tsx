...
export default function SyncPage() {
  ...
  async function handleMatch() {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/match-members", { method: "POST" });
  ...
  async function handleSync() {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/congress-votes", {
        method: "POST",
  ...
  async function handleFullSync() {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/full-vote-sync", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function handleBackfill(polId: string) {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/backfill-votes", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function handleFecMatch() {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/match-fec", { method: "POST" });
      const data = await res.json();
  ...
  async function handleFecSync(polId: string) {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/fec-donations", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ politicianId: polId }),
      });
  ...
  async function handleFecSummarySync(polId: string) {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/fec-summary", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ politicianId: polId }),
      });
  ...
  async function handleExecSync(polId: string) {
    ...
    try {
      const res = await fetch("/api/nk-manage/sync/executive-actions", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ politicianId: polId }),
      });
