...
const FORWARD_TRANSITIONS: Record<PromiseStatus, PromiseStatus[]> = {
  NOT_STARTED: ["IN_PROGRESS", "ADVANCING", "PARTIAL", "FULFILLED", "BROKEN"],
...
const REGRESSION_TRANSITIONS: Record<PromiseStatus, PromiseStatus[]> = {
  ...
  ADVANCING: ["IN_PROGRESS", "NOT_STARTED"],
  PARTIAL: ["ADVANCING", "IN_PROGRESS", "NOT_STARTED"],
  FULFILLED: ["REVERSED", "PARTIAL", "ADVANCING", "IN_PROGRESS", "NOT_STARTED"],
  BROKEN: ["REVERSED"],
  REVERSED: [],
};
